...
model = LSTM(word_dim=len(word_cnt), word_embed_dim=512, tag_dim=len(pos_cnt), hidden_dim=512, max_norm=1, use_gpu=True)
...
train_with_sgd(model, x1, y1, learning_rate=0.01, nepoch=10, evaluation_loss_after=1)
